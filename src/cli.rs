        ...
        .subcommand(App::new("source")
            ...
            .subcommand(App::new("link_check")
                ...
                .arg(Arg::new("package_name")
                    ...
                    .index(1)
                    .value_name("PKG")
                    .help("Check the source URL for this package")
                )
                .arg(Arg::new("package_version")
                    .required(false)
                    .multiple(false)
                    .index(2)
                    .value_name("VERSION")
                    .help("Check the source URL for the package in this version")
                )
                ...
                .arg(Arg::new("matching")
                    ...
                    .takes_value(true)
                    .value_name("REGEX")
                    .help("Check all packages matching a regex with their name")
                )
