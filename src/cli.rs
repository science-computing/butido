        ...
        .subcommand(Command::new("source")
            ...
            .subcommand(Command::new("url")
                ...
                .arg(Arg::new("package_version")
                    ...
                    .index(2)
                    .value_name("VERSION")
                    .help("Show the URL of this package version (or all versions, if omitted)")
                )
            )
            .subcommand(Command::new("download")
                ...
                .arg(Arg::new("package_version")
                    ...
                    .index(2)
                    .value_name("VERSION_CONSTRAINT")
                    .help("Download the sources of this package version (optional, if left out, all versions are downloaded)")
                )
                .arg(Arg::new("force")
                    .action(ArgAction::SetTrue)
                    .required(false)
            ...
            .subcommand(Command::new("of")
                ...
                .arg(Arg::new("package_version")
                    ...
                    .index(2)
                    .value_name("VERSION")
                    .help("Get the source file paths for the package in this version (or all versions, if omitted)")
                )
            )
        )
